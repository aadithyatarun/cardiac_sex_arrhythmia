...
│
├── figures/
│   └── generate_all.py       # Publication figure generation (matplotlib + seaborn)
│
├── manuscript/
│   ├── manuscript.tex        # Full LaTeX manuscript
│   ├── manuscript_v2.tex     # Revised version
│   ├── references.bib        # BibTeX bibliography
│   └── manuscript_final.docx # Word export
│
├── data/
│   └── results/              # Simulation output (.npz + .json) — generated by scripts
│
